			...
			<div class="col-10 offset-1 col-md-6 offset-md-3 p-3">
				<form id="form-crear-capacitacion" autocomplete="off">
					...
					<label for="name" class="form-label">Nombre</label>
						<input placeholder="minimo 8 caracteres, maximo 100" type="text"
							class="form-control" id="name" name="name" />
					</div>
					<div class="mb-4">
					<label for="detalle" class="form-label">Detalle</label>
						<textarea placeholder="minimo 6 caracteres, maximo 500" type="text" class="form-control" id="detail" name="detail" /></textarea>
					</div>
