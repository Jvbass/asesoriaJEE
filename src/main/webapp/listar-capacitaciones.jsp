			...
			<div class="col-12 col-md-8 offset-md-2 p-3">
					...
					<tbody class="table-group-divider">
						...
						<tr>
							...
							<td><a class="text-success"
								href="ServletCrudCapacitaciones?option=formUpdateCapacitacion&idCapacitacion=<%=s.getId()%>"><i
									class="fa-solid fa-pen-to-square mx-3"></i></a> 
									<a class="text-danger"
								href="ServletCrudCapacitaciones?option=deleteCapacitacion&idCapacitacion=<%=s.getId()%>"><i
				...
				<div>
					<a class="btn btn-outline-success mt-3"
						href="ServletCrearCapacitacion">Nueva capacitacion</a>
				</div>
			</div>
		</div>
	</div>
